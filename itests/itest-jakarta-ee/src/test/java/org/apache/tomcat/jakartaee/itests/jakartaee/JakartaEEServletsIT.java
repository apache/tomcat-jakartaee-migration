...
/**
 * Tests the Java EE application converted to Jakarta EE on a Jakarta EE container,
 * by checking that the index page returns a code 200.
 */
public class JakartaEEServletsIT {
    /**
    ...
    public static void initializeTest() {
        ...
        try {
            ...
            Assert.fail("Invalid base URL: " + JakartaEEServletsIT.baseUrl + ": " + e);
        }
    }
